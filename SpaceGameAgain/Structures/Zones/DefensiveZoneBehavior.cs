...
//    public DefensiveZoneBehavior(Structure instance) : base(instance)
//    {
//        upgrades = [
...
//    {
//        foreach (var cell in Structure.Prototype.Footprint)
//        {
...
//    {
//        var gridCell = Structure.Grid.GetCell(Structure.Location + localCell + offset);
//        if (gridCell != null && gridCell.Structure == Structure)
//        {
