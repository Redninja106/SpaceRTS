...
internal class StructureList
{
    ...
    public Structure LargeShipyard { get; } = new(
        "large shipyard",
        5,
        new Model([
    ...
    public Structure SmallShipyard { get; } = new(
        "small shipyard",
        5,
        new Model([
    ...
    public Structure ResourceNode { get; } = new(
        "Resource Deposit",
        int.MaxValue,
        new Model([
    ...
    public Structure DefensiveZone { get; } = new ZoneStructure(
        "Defensive Zone",
        10,
    ...
    public Structure IndustrialZone { get; } = new ZoneStructure(
        "Industrial Zone",
        10,
        new Model([new CanvasShape((c, r) =>
        {
    ...
    public Structure EconomicZone { get; } = new ZoneStructure(
        "Economic Zone",
        10,
        new Model([new CanvasShape((c, r) =>
        {
    ...
    public Structure ResearchZone { get; } = new ZoneStructure(
        "Research Zone",
        10,
        new Model([new CanvasShape((c, r) =>
        {
