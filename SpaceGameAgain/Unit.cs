...
namespace SpaceGame;
internal abstract class Unit(UnitPrototype prototype, ulong id, Transform transform, ActorReference<Team> team) : WorldActor(prototype, id, transform), IDestructable
{
